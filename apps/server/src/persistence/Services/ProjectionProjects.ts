 ...
 */
import { IsoDateTime, ProjectId, ProjectScript } from "@arbortools/contracts";
...
export const ProjectionProject = Schema.Struct({
  ...
  repoSlug: Schema.NullOr(Schema.String).pipe(Schema.withDecodingDefault(() => null)),
...
>()("arbor/persistence/Services/ProjectionProjects/ProjectionProjectRepository") {}
