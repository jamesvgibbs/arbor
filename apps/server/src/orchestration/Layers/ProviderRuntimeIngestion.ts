...
import { makeDrainableWorker } from "@arbortools/shared/DrainableWorker";
...
const STRICT_PROVIDER_LIFECYCLE_GUARD = process.env.ARBOR_STRICT_PROVIDER_LIFECYCLE_GUARD !== "0";
