...
> {
  return Effect.gen(function* () {
    const remoteDir = yield* makeTempDir("arbor-git-remote-");
...
function createGitHubCliWithFakeGh(scenario: FakeGhScenario = {}): {
  ...
  const execute: GitHubCliShape["execute"] = (input) => {
    ...
    if (args[0] === "pr" && args[1] === "create") {
      return Effect.succeed({
        stdout:
          (scenario.createdPrUrl ?? "https://github.com/jamesvgibbs/arbor/pull/101") + "\n",
        stderr: "",
        code: 0,
        signal: null,
        timedOut: false,
    ...
    if (args[0] === "pr" && args[1] === "view") {
      const pullRequest: FakePullRequest = scenario.pullRequest ?? {
        number: 101,
        title: "Pull request",
        url: "https://github.com/jamesvgibbs/arbor/pull/101",
        baseRefName: "main",
...
it.layer(GitManagerTestLayer)("GitManager", (it) => {
  it.effect("status includes PR metadata when branch already has an open PR", () =>
    Effect.gen(function* () {
      const repoDir = yield* makeTempDir("arbor-git-manager-");
            ...
            JSON.stringify([
              {
                number: 13,
                title: "Existing PR",
                url: "https://github.com/jamesvgibbs/arbor/pull/13",
                baseRefName: "main",
  ...
  it.effect(
    ...
    () =>
      Effect.gen(function* () {
        ...
        yield* runGit(repoDir, ["checkout", "-b", "arbor/pr-488/statemachine"]);
        yield* runGit(repoDir, ["branch", "--set-upstream-to", "fork-seed/statemachine"]);
        yield* runGit(repoDir, [
          "config",
          "remote.fork-seed.url",
          "git@github.com:jasonLaster/arbor-test.git",
        ]);
              ...
              JSON.stringify([
                {
                  ...
                  url: "https://github.com/jamesvgibbs/arbor/pull/488",
                  baseRefName: "main",
        ...
        const status = yield* manager.status({ cwd: repoDir });
        expect(status.branch).toBe("arbor/pr-488/statemachine");
        expect(status.pr).toEqual({
          number: 488,
          title: "Rebase this PR on latest main",
          url: "https://github.com/jamesvgibbs/arbor/pull/488",
            ...
            JSON.stringify([
              {
                number: 22,
                title: "Merged PR",
                url: "https://github.com/jamesvgibbs/arbor/pull/22",
                baseRefName: "main",
            ...
            JSON.stringify([
              {
                number: 45,
                title: "Merged PR",
                url: "https://github.com/jamesvgibbs/arbor/pull/45",
                baseRefName: "main",
              ...
              },
              {
                number: 46,
                title: "Open PR",
                url: "https://github.com/jamesvgibbs/arbor/pull/46",
                baseRefName: "main",
                headRefName: "feature/status-open-over-merged",
                state: "OPEN",
                updatedAt: "2026-01-30T10:00:00Z",
              ...
              JSON.stringify([
                {
                  ...
                  url: "https://github.com/jamesvgibbs/arbor/pull/77",
                  baseRefName: "main",
            ...
            JSON.stringify([
              {
                number: 42,
                title: "Existing PR",
                url: "https://github.com/jamesvgibbs/arbor/pull/42",
                baseRefName: "main",
    ...
    () =>
      Effect.gen(function* () {
        ...
        yield* runGit(repoDir, [
          "config",
          "remote.fork-seed.url",
          "git@github.com:octocat/arbor-test.git",
        ]);
              ...
              JSON.stringify([
                {
                  ...
                  url: "https://github.com/jamesvgibbs/arbor/pull/142",
                  baseRefName: "main",
                  headRefName: "statemachine",
                },
              ]),
  ...
  it.effect(
    ...
    () =>
      Effect.gen(function* () {
        ...
        yield* runGit(repoDir, ["remote", "add", "fork-seed", forkDir]);
        yield* runGit(repoDir, ["push", "-u", "fork-seed", "statemachine"]);
        yield* runGit(repoDir, ["checkout", "-b", "arbor/pr-142/statemachine"]);
        yield* runGit(repoDir, ["branch", "--set-upstream-to", "fork-seed/statemachine"]);
        yield* runGit(repoDir, [
          "config",
          "remote.fork-seed.url",
        ...
        const { manager, ghCalls } = yield* makeManager({
          ghScenario: {
            prListByHeadSelector: {
              "arbor/pr-142/statemachine": JSON.stringify([]),
              statemachine: JSON.stringify([
                {
                  number: 41,
                  title: "Unrelated same-repo PR",
                  url: "https://github.com/jamesvgibbs/arbor/pull/41",
                  baseRefName: "main",
                  headRefName: "statemachine",
                },
              ]),
            ...
            JSON.stringify([
              {
                number: 88,
                title: "Add stacked git actions",
                url: "https://github.com/jamesvgibbs/arbor/pull/88",
                baseRefName: "main",
  ...
  it.effect("creates cross-repo PRs with the fork owner selector and default base branch", () =>
    Effect.gen(function* () {
      ...
      yield* runGit(repoDir, ["commit", "-m", "Feature commit"]);
      yield* runGit(repoDir, ["push", "-u", "fork-seed", "statemachine"]);
      yield* runGit(repoDir, ["checkout", "-b", "arbor/pr-91/statemachine"]);
      yield* runGit(repoDir, ["branch", "--set-upstream-to", "fork-seed/statemachine"]);
      yield* runGit(repoDir, [
        "config",
        "remote.fork-seed.url",
            ...
            JSON.stringify([
              {
                number: 188,
                title: "Add stacked git actions",
                url: "https://github.com/jamesvgibbs/arbor/pull/188",
                baseRefName: "main",
                headRefName: "statemachine",
              },
            ]),
      ...
      const { manager, ghCalls } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            number: 64,
            title: "Local PR",
            url: "https://github.com/jamesvgibbs/arbor/pull/64",
            baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            number: 81,
            title: "Fork PR",
            url: "https://github.com/jamesvgibbs/arbor/pull/81",
            baseRefName: "main",
            headRefName: "feature/pr-fork",
            state: "open",
            isCrossRepository: true,
            headRepositoryNameWithOwner: "octocat/arbor-test",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            number: 82,
            title: "Local Fork PR",
            url: "https://github.com/jamesvgibbs/arbor/pull/82",
            baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            ...
            url: "https://github.com/jamesvgibbs/arbor/pull/642",
            baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            ...
            url: "https://github.com/jamesvgibbs/arbor/pull/78",
            baseRefName: "main",
  ...
  it.effect(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const { manager } = yield* makeManager({
          ghScenario: {
            pullRequest: {
              number: 91,
              title: "Fork main PR",
              url: "https://github.com/jamesvgibbs/arbor/pull/91",
              baseRefName: "main",
              headRefName: "main",
              state: "open",
              isCrossRepository: true,
        ...
        expect(result.branch).toBe("arbor/pr-91/main");
        expect(result.worktreePath).not.toBeNull();
  ...
  it.effect(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const { manager } = yield* makeManager({
          ghScenario: {
            pullRequest: {
              ...
              url: "https://github.com/jamesvgibbs/arbor/pull/92",
              baseRefName: "main",
              headRefName: "main",
              state: "open",
              isCrossRepository: true,
        ...
        expect(result.branch).toBe("arbor/pr-92/main");
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            ...
            url: "https://github.com/jamesvgibbs/arbor/pull/83",
            baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            number: 79,
            title: "Root-only PR",
            url: "https://github.com/jamesvgibbs/arbor/pull/79",
            baseRefName: "main",
