...
import { sanitizeBranchFragment, sanitizeFeatureBranchName } from "@arbortools/shared/git";
...
const makeCodexTextGeneration = Effect.gen(function* () {
  ...
  const writeTempFile = (
    ...
    const filePath = path.join(tempDir, `arbor-${prefix}-${process.pid}-${randomUUID()}.tmp`);
