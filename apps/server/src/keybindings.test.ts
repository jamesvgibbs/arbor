import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@arbortools/contracts";
    ...
    Layer.provideMerge(
      Layer.effect(
        ...
        Effect.gen(function* () {
          ...
          const dir = yield* fs.makeTempDirectoryScoped({ prefix: "arbor-server-config-test-" });
